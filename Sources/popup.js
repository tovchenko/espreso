...
es.Popup = cc.Layer.extend({
    ...
    dismiss: function() {
        ...
        this._fadeLayer.runAction(cc.sequence(
            cc.fadeTo(es.POPUP.ANIM_TIME1 + es.POPUP.ANIM_TIME2, 0),
            cc.callFunc(cc.Node.prototype.removeFromParent.bind(this))));
    },

    onEnterTransitionDidFinish: function() {
        this._super();
        if (0 === this._fadeLayer.getOpacity())
            this._fadeLayer.runAction(cc.fadeTo(es.POPUP.ANIM_TIME1 + es.POPUP.ANIM_TIME2, 155));
    },
    ...
    _performTransition: function(forShowing) {
        ...
        if (forShowing) {
            ...
            this._widget.runAction(cc.sequence(cc.scaleTo(es.POPUP.ANIM_TIME1, es.POPUP.MAX_SCALE),
                                               cc.scaleTo(es.POPUP.ANIM_TIME2, 1)));
        } else {
            this._widget.runAction(cc.sequence(cc.scaleTo(es.POPUP.ANIM_TIME2, es.POPUP.MAX_SCALE),
                                               cc.scaleTo(es.POPUP.ANIM_TIME1, 0)));
        }
    },
