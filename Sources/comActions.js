...
es.playAnimation = es.PlayAnimation.create;
...
es.stopAnimation = es.StopAnimation.create;
...
es.playMusic = es.PlayMusic.create;
...
es.playArmature = es.PlayArmature.create;